...
// GetRequests is a func which takes the incoming request for the bin requests and returns the requests
...
func NewGetRequestsForBin(services *deps.Services, config *deps.Config) GetRequests {
